...
export const WRITING_PAGE_COPY = {
  ...
  generateDoneSaved: "生成完成，已保存为当前版本",
  ...
  rewriteAppliedSaved: "已保存重写结果为当前版本",
  versionActivated: "已切换当前版本",
  versionActivateNeedsSaveFirst: "请先保存或放弃当前未保存修改，再切换版本。",
  versionActivateDoneReadonly: `本章已定稿，请先回退为 ${DRAFTING_LABEL} 再切换版本。`,
  versionCompare: "与上一个版本比较",
  versionCompareNeedsSaveFirst: "请先保存或放弃当前未保存修改后再对比版本。",
  versionCompareUnavailable: "没有可对比的上一个版本。",
